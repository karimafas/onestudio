...
export function AddUserCard() {
  return (
    <div className="h-50 w-64 bg-white rounded-2xl drop-shadow-2xl mt-6 ml-6 hover:translate-y-[-0.5rem] transition-all duration-500 cursor-pointer flex flex-row items-center p-8">
