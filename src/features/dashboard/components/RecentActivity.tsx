...
import { loadMoreActivity } from "../../../reducers/dataSlice";
        ...
        {props.activity.length === 0 ? (
          <div className="w-full h-full flex flex-col items-center pt-20">
            ...
            <span className="text-xs text-dark_blue text-center px-8">
              As you start working with your inventory, this is where you'll be
              able to track your actions and progress.
            </span>
          </div>
        ) : (
          <></>
